...
#define DBG_DOME_PUT_ABORT
#define DBG_DOME_PUT_CLOSE
#define DBG_DOME_PUT_FIND_HOME
#define DBG_DOME_PUT_OPEN
#define DBG_DOME_PUT_PARK
#define DBG_DOME_PUT_SET_PARK
#define DBG_DOME_PUT_SLEW_TO_ALT
#define DBG_DOME_PUT_SLEW_TO_AZ
#define DBG_DOME_PUT_SYNC_TO_AZ
#define DBG_DOME_GET_ALT
#define DBG_DOME_GET_AT_HOME
#define DBG_DOME_GET_AT_PARK
#define DBG_DOME_GET_AZ
#define DBG_DOME_GET_CAN_FIND_HOME
#define DBG_DOME_GET_CAN_PARK
#define DBG_DOME_GET_CAN_SET_ALT
#define DBG_DOME_GET_CAN_SET_AZ
#define DBG_DOME_CAN_SET_PARK
#define DBG_DOME_CAN_SET_SHUTTER
#define DBG_DOME_CAN_SLAVE
#define DBG_DOME_GET_CAN_SYNC_AZ
#define DBG_DOME_GET_SHUTTER
#define DBG_DOME_GET_SLAVED
#define DBG_DOME_PUT_SLAVED
#define DBG_DOME_GET_SLEWING

#define DBG_SAFETYMONITOR_GET_IS_SAFE
